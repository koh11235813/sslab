...
def train(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if val_miou > best_miou:
            best_miou = val_miou
            ckpt_path = out_dir / "best_segformer_b2.pt"
            torch.save(
                {
                    "epoch": epoch,
    ...
    # 最終モデルも保存しておく
    torch.save(model.state_dict(), out_dir / "last_segformer_b2.pt")
...
def parse_args():
    ...
    parser.add_argument("--out_dir", type=str, default="./checkpoints_segformer_b2")
